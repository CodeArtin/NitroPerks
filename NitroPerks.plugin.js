...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "authors": [{
                "name": "16.Artin",
                "github_username": "Milka Code"
            }],
            "version": "1.3.6",
            "description": "Unlock all screensharing modes, and use cross-server emotes & gif emotes, Discord wide! (You CANNOT upload 100MB files though. :/) Made by 16.Artin",
